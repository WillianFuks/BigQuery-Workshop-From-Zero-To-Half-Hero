...
One of the best techniques for being effective in BigQuery is to better understand how to leverage its nested data paradigm which basically already stores everything needed for computation in a single row which avoids shuffling data around.
